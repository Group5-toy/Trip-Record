...
=======
## 👨‍💻 팀원 소개
>>>>>>> 527a7d226379e8e0cc9aa605184db69b707d2d17
|이름|Github 주소|
|----|-----------|
...
=======
|GET|/trips/{id}|-|{<br>status : Success,<br>code : xx,<br>data : TripDetailResponse<br>}|단 건의 여행 이름과 그에 속한 여정들에 대한 정보들을 조회해온다.|
|GET|/trips/all|-|{<br>status : Success,<br>code : xx,<br>data : data : List\<TripDetailResponse><br>}|다 건의 여행과 그에 속한 여정 이름들을 조회해온다.|
|POST|/trips/{tripId}/journeys|List\<MoveJourney> <br> List\<StayJourney> <br> List\<LiveJourney>|{<br>status : Success,<br>code : xx,<br>data : journeyCreateResponse<br>}|특정 여행의 여정목록을 저장한다.|
